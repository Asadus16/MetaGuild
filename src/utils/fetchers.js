...
export const getDao = async (daoId) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}`, {
      method: 'get',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const getDaoUser = async (authToken, daoId) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}/ismember`, {
      method: 'get',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const joinDao = async (authToken, daoId) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}/join`, {
      method: 'get',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const getDaoMembers = async (daoId) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}/members`, {
      method: 'get',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const getDaoAdmin = async (daoId) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}/admin`, {
      method: 'get',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const getUserTasks = async (authToken) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/tasks/user`, {
      method: 'get',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const createDaoTask = async (authToken, daoId, taskData) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}/task`, {
      method: 'post',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const updateDaoTask = async (authToken, daoId, taskId, taskData) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}/task/${taskId}`, {
      method: 'put',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const assignTaskToUser = async (authToken, taskId, userId) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/tasks/${taskId}/assign`, {
      method: 'put',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
...
export const updateDaoUserRole = async (authToken, daoId, role, userId) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/daos/${daoId}/user/${userId}`, {
      method: 'put',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
